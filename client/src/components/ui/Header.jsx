...
export const Header = () => {
  ...
  return (
    <header
      className={`fixed top-0 z-50 flex w-screen justify-center bg-white py-4 ${hasShadow ? 'shadow-md' : ''
        }`}
    >
      <div
      ...
      >
        ...
        <div className="flex items-center gap-4">
          <Link to="/about" className="hidden text-base font-semibold text-gray-600 hover:text-primary md:block">
            About
          </Link>
